...
export const createMovieCard = (movie) => {
    return `<div class="w-[calc(50%-0.5rem)] flex flex-col gap-2 bg-secondary-bg rounded-xl overflow-hidden relative lg:w-[calc(16.66%-1rem)] lg:bg-transparent" data-content="movie_card" data-id="${movie.imdbID}">
                  ...
                  <img src="${movie.Poster}" alt="" class="max-h-60 min-h-60 object-cover rounded-t-xl lg:max-h-68 lg:min-h-68 lg:rounded-xl transition-all duration-300 ease-in-out lg:hover:scale-110" data-content="movie_poster">
